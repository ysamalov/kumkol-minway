...
-- =============================================================
-- 0. ЗАГЛУШКА detect_vehicle_type
-- =============================================================
-- Функция создаётся здесь как заглушка, чтобы миграция не падала
-- при первом запуске Docker (до того, как накатан update_catalogs.sql).
-- Реальная реализация с полными правилами определения типа техники
-- будет установлена позже через update_catalogs.sql.
-- =============================================================
